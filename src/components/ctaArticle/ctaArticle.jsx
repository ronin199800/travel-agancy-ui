...
const CtaArticle = () => {
  ...
  return (
    <div
      className={` theme-box-${context.mode} theme-text-${context.mode} sidebar ${isFixed ? 'fixed' : ''}`}
    >
      ...
      <div className="cta-test">
        <span>
          برای مشاوره و رزرو تور همین حالا با ما تماس گیرید !
        </span>
        <span style={{display:'block',padding:'.3rem'}} className={`text-mute-${context.mode}`}>هم اکنون پاسخگوی شما هستیم</span>
      </div>
